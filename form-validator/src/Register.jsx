      ...
      <div className={styles.container}>
        <form className={styles.formData} onSubmit={formik.handleSubmit}>
          ...
          <div>
            ...
            />
            {formik.touched.username && formik.errors.username && (<div className={styles.errors}>{formik.errors.username ? formik.errors.username : null}</div>)}
          </div>
          <div>
            <label>Email</label>
          ...
          <div>
            ...
            <input name="password" type="password" placeholder='Enter Password' className={`${formik.touched.password && formik.errors.password ? styles.input_errors : '' }${formik.touched.password && !formik.errors.password ? styles.input_success : '' }`} value={formik.values.password} onChange={formik.handleChange}/>
